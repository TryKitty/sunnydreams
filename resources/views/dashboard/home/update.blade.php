  ...
  <div class="row">
   ...
   <div class="col-md-9 ml-3 mt-2 bg-dark rd">
    <div class="container-fluid text-light">
     <form
      action="{{ route('Dashboard-home.update',$show->id) }}"
      method="post"
